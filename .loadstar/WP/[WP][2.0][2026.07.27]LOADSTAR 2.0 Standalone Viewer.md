...
G6. 그룹 편집기 — GROUP의 CONNECTIONS.ITEMS를 텍스트가 아니라 목록 UI로 관리
G7. v1 구조 v2 전환 — 기존 v1(loadstar_cli) 프로젝트 데이터를 v2 스펙으로 변환
...
- CHILDREN:
  ...
  - [WP][2.0][2026.07.28]그룹 편집기.md
  - [WP][2.0][2026.07.28]v1 구조 v2 전환.md
- REFERENCE: []
